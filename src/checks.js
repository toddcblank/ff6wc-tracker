...
let figaroCastleWob = {
    ...
    itemName: "Doma Castle WoB",
    itemClickStates: ["uncollected", "collected"],
    itemAvailability: ["both"]}
let figaroCastleWor = {
    itemIcon: "./icons/tentacle.gif",
    itemName: "Doma Castle WoR",
    itemClickStates: ["uncollected", "collected"],
    itemAvailability: ["wor"]}
...
let dragonsGroup = {
    ...
    let trackerJson = [
        {
          groupIcon: strago,
          groupedItems: [burningHouse, ebotsRock, fanaticsTower]
        },{
          groupIcon: mog,
          groupedItems: [loneWolf]
        },
        {
            groupIcon: umaro,
            groupedItems: [umaroBoss]
        },{
          groupIcon: relm,
          groupedItems: [esperMountain, owzersMansion]
        },{
          groupIcon: gogo,
          groupedItems: [zoneEater]
        },{
          groupIcon: setzer,
          groupedItems: [kohlingen, darylsTomb]
        },{
          groupIcon: edgar,
          groupedItems: [figaroCastleWob, ancientCastle, figaroCastleWor]
        },{
          groupIcon: gau,
          groupedItems: [serpentTrench, veldt]
        },{
          groupIcon: cyan,
          groupedItems: [domaWob, domaWor, mtZozo]
        },{
          groupIcon: locke,
          groupedItems: [
            southFigaroCave, narsheWeaponShop, phoenixCave, ]
        },{
          groupIcon: celes,
          groupedItems: [
            magitekIfrit, 
